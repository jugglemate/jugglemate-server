# embedded-console-web Specification

## Purpose
Defines how the console web application is served from the Go server as embedded static assets under the `/jmateconsole` URL prefix.
